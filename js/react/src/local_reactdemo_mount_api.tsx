...
export function init(el, props = {}) {
    ...
    //            ^container  ^component  ^props  ^Profiler id
}`;
 ...
 *
 * Profiling rules:
 *  ✅ export default function  — react_autoinit calls mountReactApp() automatically.
 *  ✅ init() + mountReactApp() — you call it yourself; same Profiler wrapping.
 *  ❌ createRoot().render()    — bypasses mountReactApp(); never profiled.
 *
